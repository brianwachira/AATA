                ...
                <div className="row h-100">
                    <div className="col-12 col-md-5 h-100 d-grid">
                        ...
                        <div className="comingsoon-text">
                            <h5 className='text-center'>This page is under construction</h5>
                            <h6 className='text-center mb-5'>We are changing a few aesthetics so that you can have the best analysis experience. We will be back up soon.</h6>
                            <Link to='/'>
